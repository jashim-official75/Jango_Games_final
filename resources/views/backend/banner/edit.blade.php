                    ...
                    <div class="card-body">
                        <form action="{{ route('banner.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="video_url" id="video_url" class="form-control" value="{{ $banner->video_url }}">
                                    @error('video_url')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="review" id="review" class="form-control" value="{{ $banner->review }}">
                                    @error('review')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
