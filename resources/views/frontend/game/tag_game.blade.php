...
@section('header')
    <meta property="og:title" content="{{ $single_tag->meta_title ?? '' }}">
    <meta property="og:description" content="{{ $single_tag->meta_description ?? '' }}">
    <meta property="og:image" content="{{ asset('assets/frontend/images/logo/jango-games-logo.png') }}" />
    <meta property="og:url" content="{{ url()->current() }}">
    <meta name="title" content=" {{ $single_tag->meta_title ?? '' }}" />
    <meta name="description" content="{{ $single_tag->meta_description ?? '' }}">

    <meta name="keywords" content="{{ $single_tag->meta_keyword ?? '' }}" />

    <link rel="canonical" href="{{ url()->current() }}" />
    <title>{{ $single_tag->title }} Games | Play Free Online {{ $single_tag->title }} Games On Jango Games
    </title>
@endsection
