...
@section('header')
    <meta property="og:title" content="Play thousands of free online games on Jango Games | All Tags">
    <meta property="og:description"
        content="Play thousands of free online games on Jango Games | All Tags. Find the best free games you will love to play. Play all your favorite games like puzzle games, word and trivia games, card games, multiplayer games and more.">
    ...
    <title>Jango Games: Play Games Online | All Tags</title>
@endsection
        ...
        <div class="section_title text-center">
            ...
            <div class="section_title-text text-center">
                <p>Jango Games has the top popular Tags games, all completely free to play! We also have a variety of
                    different genres, categories and tags. Like running, multiplayer, ball, 3d, and assassin games online!
                </p>
            </div>
        </div>
                ...
                @foreach ($tags as $tag)
                    <div class="tagCard" style="--i:{{ $tag->color_code }}" data-tilt data-tilt-glare
                        ...
                        <div class="tagCard_name">
                            <a href="{{ route('tagGame', $tag->slug) }}" title="MineCraft" data-bs-toggle="tooltip"
